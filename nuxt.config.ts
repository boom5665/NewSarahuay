export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        {
          name: "description",
          content: "ข่าวหวย ผลหวย และสถิติย้อนหลัง",
        },
  ...
  sitemap: {
    // siteUrl: "https://sarahuay.com",
    // urls: async () => {
    //   const config = await fetch(
    //     "https://api.domain.com/api/v1/seo/config"
    //   ).then((r) => r.json());
    //   // ปิด sitemap จาก BO
  ...
  robots: {
    ...
    sitemap: "https://sarahuay.com/sitemap.xml",
  },
  routeRules: {
    "/old-news": {
      redirect: "/news",
