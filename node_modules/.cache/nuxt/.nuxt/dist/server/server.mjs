import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, computed, unref, provide, ref, watch, h, shallowRef, isReadonly, createElementBlock, cloneVNode, isRef, toValue, onServerPrefetch, nextTick, isShallow, isReactive, toRaw, markRaw, onScopeDispose, toRefs, defineAsyncComponent, Suspense, mergeProps, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { defu } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL as parseURL$1, encodePath as encodePath$1, decodePath, isScriptProtocol } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ufo/dist/index.mjs";
import { debounce } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, useSeoMeta as useSeoMeta$1, headSymbol } from "/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@unhead/vue/dist/index.mjs";
...
function createRouterError(type, params) {
  if (process.env.NODE_ENV !== "production" || false) return assign$1(new Error(ErrorTypeMessages[type](params)), {
    type,
    [NavigationFailureSymbol]: true
  }, params);
  else return assign$1(/* @__PURE__ */ new Error(), {
    type,
    [NavigationFailureSymbol]: true
  }, params);
}
...
- Location:`, rawLocation);
    ...
    if (process.env.NODE_ENV !== "production" && hash2 && !hash2.startsWith("#")) warn$1(`A \`hash\` should always start with the character "#". Replace "${hash2}" with "#${hash2}".`);
...
const _routes = [
  {
    name: "detailsnew-id",
    path: "/detailsnew/:id()",
    component: () => import("./_nuxt/_id_-MF0OWXHG.js")
  },
  {
    name: "aigen",
    path: "/aigen",
    component: () => import("./_nuxt/aigen-DNlQRbU3.js")
  },
  {
    name: "lotto",
    path: "/lotto",
    component: () => import("./_nuxt/lotto-CID2v_hd.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-BV9iwgFx.js")
  },
  {
    name: "reward",
    path: "/reward",
    component: () => import("./_nuxt/reward-C6zbq40m.js")
  },
  {
    name: "supers",
    path: "/supers",
    component: () => import("./_nuxt/supers-CRW7M6O3.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DlEjCZ6j.js")
  },
  {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Bmtrzw7l.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bb3ns1WB.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Brp-pBkx.js"));
