...
import { useLogger, addTypeTemplate, defineNuxtModule, createResolver, addImports, addServerImports, addPlugin, extendRouteRules, addPrerenderRoutes, addServerHandler, addServerPlugin, addServerImportsDir } from '@nuxt/kit';
import { installNuxtSiteConfig, updateSiteConfig } from 'nuxt-site-config/kit';
import { relative } from 'pathe';
import { readPackageJSON } from 'pkg-types';
import { withoutTrailingSlash, withoutLeadingSlash, withLeadingSlash, withTrailingSlash } from 'ufo';
import { ROBOT_DIRECTIVE_VALUES, NonHelpfulBots, AiBots, parseRobotsTxt, validateRobots, asArray, normalizeGroup, normaliseRobotsRouteRule, formatMaxImagePreview, formatMaxSnippet, formatMaxVideoPreview } from './util.mjs';
import { setupDevToolsUI as setupDevToolsUI$1 } from 'nuxtseo-shared/devtools';
import { generatePathForI18nPages, resolveI18nConfig, splitPathForI18nLocales } from 'nuxtseo-shared/i18n';
import { resolveNitroPreset, resolveNuxtContentVersion, isNuxtGenerate } from 'nuxtseo-shared/kit';
import 'defu';

function setupDevToolsUI(_options, resolve, nuxt) {
  setupDevToolsUI$1({ route: "/__nuxt-robots", name: "nuxt-robots", title: "Robots", icon: "carbon:bot" }, resolve, nuxt);
}
...
`
  ...
  const nitroAugmentation = (mod) => `declare module '${mod}' {
  interface NitroApp {
    _robots: {
