...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, readBody, getRequestProtocol, getRequestHost, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, decodePath, withLeadingSlash, encodePath, joinRelativeURL, withBase, parsePath, stringifyQuery, parseQuery, stringifyParsedURL } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/unhead/dist/utils.mjs';
import { createFilter } from 'file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/nuxtseo-shared/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/server/assets"}];
...
const _47Users_47jarkkarpongsukprasop_47Documents_47GitHub_47NewSarahuay_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47Users_47jarkkarpongsukprasop_47Documents_47GitHub_47NewSarahuay_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/.data/kv"}));
...
const _OjgBliniZpXe949WjQ5mQT4Jxl1AekCJEUWfEOUVUI = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"ข่าวหวย ผลหวย และสถิติย้อนหลัง"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"icon","type":"image/png","href":"/icon_tab.png"}],"style":[],"script":[],"noscript":[],"title":"Sarahuay","htmlAttrs":{"lang":"th","translate":"no"}};
...
const _PHCKn_1ywU7iQ5VKB_8MpyRY1BvtFuy5NkbVb_haLo = (nitroApp) => {
...
const _WVI_CY = eventHandler(async (e) => {
...
async function parseSitemapIndex(xml) {
  ...
  const { XMLParser } = await import('file:///Users/jarkkarpongsukprasop/Documents/GitHub/NewSarahuay/node_modules/fast-xml-parser/src/fxp.js');
...
const _UlEWhF = defineEventHandler(async (e) => {
...
const _yMiezP = defineEventHandler(async (e) => {
...
const _KYZot_ = defineEventHandler(async (e) => {
...
const _A4KfGx = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _OBjovh = defineEventHandler(async (e) => {
  const { url, mode } = getQuery$1(e);
  if (!url || typeof url !== "string")
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _WVI_CY, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _UlEWhF, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug-production.json', handler: _yMiezP, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/__robots__/debug.json', handler: _KYZot_, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _A4KfGx, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-production.json', handler: _OBjovh, lazy: false, middleware: false, method: undefined },
